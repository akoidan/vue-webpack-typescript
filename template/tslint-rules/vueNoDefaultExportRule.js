...
var Rule = /** @class */ (function (_super) {
    ...
    Rule.metadata = {
        ruleName: "vue-no-default-export",
...
exports.Rule = Rule;
function walk(ctx) {
    if (ctx.sourceFile.isDeclarationFile || !ts.isExternalModule(ctx.sourceFile) || ctx.sourceFile.fileName.endsWith('.vue')) {
        return;
    }
    for (var _i = 0, _a = ctx.sourceFile.statements; _i < _a.length; _i++) {
        ...
        else if (statement.modifiers !== undefined &&
